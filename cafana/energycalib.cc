...
int main()
{
    ...
    // SBND
    ana::Analysis analysis("sbnd_bnb_mc_energycalib");
    ana::SpectrumLoader mc("/pnfs/sbnd/scratch/users/mueller/v10_04_07/bnb_rockbox_cosmics_v10_04_07/input*.flat.root");
