...
{   
    ...
    template<class T>
        ...
        {
	  std::vector<uint32_t> c(utilities_pi02024::count_primaries(obj));
     ...
     */
    template<class T>
      bool all_1mu0pi2gamma_cut(const T & obj) {return fiducial_cut<T>(obj) && track_containment_cut<T>(obj) && flash_cut_bnb<T>(obj) && topological_1mu0pi2gamma_cut<T>(obj) && pi0_mass_cut<T>(obj);}
