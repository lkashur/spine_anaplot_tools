 ...
 */
#ifndef VARS_PI02024_TRAD_H
#define VARS_PI02024_TRAD_H
...
namespace vars::pi02024_trad
{
	...
	if(cuts::fiducial_cut(obj))
	{
      ...
      // Neutrino Background              
      else if(cuts::pi02024_trad::other_nu_1mu0pi1pi0(obj))
      {
	cat = 2;
      }
      return cat;
