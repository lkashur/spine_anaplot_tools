 ...
 */
#ifndef VARS_PI02024_PHASE_H
#define VARS_PI02024_PHASE_H
...
namespace vars::pi02024_phase
{
    ...
    double category(const caf::SRInteractionTruthDLPProxy & obj)
    {
      ...
      // Signal   
      if(cuts::pi02024_phase::signal_1mu0pi1pi0(obj))
      {
	if(cuts::fiducial_cut(obj))
	{
      ...
      // Neutrino Background              
      else if(cuts::pi02024_phase::other_nu_1mu0pi1pi0(obj))
      {
	cat = 2;
      }
      return cat;
