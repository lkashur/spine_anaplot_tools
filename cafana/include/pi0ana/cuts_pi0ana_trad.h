...
*/
#ifndef CUTS_PI0ANA_TRAD_H
#define CUTS_PI0ANA_TRAD_H
#include <vector>
#include <numeric>
#include <cmath>
#include <algorithm>

#include "utilities_pi0ana_trad.h"

/**
 * @namespace cuts::pi0ana_trad
...
namespace cuts::pi0ana_trad
{
  ...
  //}
    ...
    template<class T>
        ...
        {
	    std::vector<uint32_t> c(utilities_pi0ana_trad::count_primaries(obj));
