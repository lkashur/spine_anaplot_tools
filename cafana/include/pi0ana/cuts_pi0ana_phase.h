...
#include "utilities_pi0ana_phase.h"

/**
 * @namespace cuts::pi0ana_phase
...
namespace cuts::pi0ana_phase
{
  ...
  //}
    ...
    template<class T>
        ...
        {
	    std::vector<uint32_t> c(utilities_pi0ana_phase::count_primaries(obj));
