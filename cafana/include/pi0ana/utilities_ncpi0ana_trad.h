/**
 * @file utilities_ncpi0ana_trad.h
 ...
 */
#ifndef UTILITIES_NCPI0ANA_TRAD_H
#define UTILITIES_NCPI0ANA_TRAD_H
...
/**
 * @namespace utilities_ncpi0ana_trad
...
namespace utilities_ncpi0ana_trad
{
	...
	if(primary_muon_count_thresh == 0 && primary_pion_count_thresh == 0 && primary_pi0_count_thresh == 1 && obj.current_type != 0 && obj.is_fiducial)
	{      
...
#endif // UTILITIES_NCPI0ANA_TRAD_H
