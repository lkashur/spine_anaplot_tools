...
*/
#ifndef CUTS_PI0ANA_NC_G1P_H
#define CUTS_PI0ANA_NC_G1P_H
#include <vector>
#include <numeric>
#include <cmath>
#include <algorithm>
...
namespace cuts::pi0ana_nc_g1p
{
  ...
  //}
    ...
    template<class T>
	    ...
	    return c[0] == 2 && c[2] == 0 && c[3] == 0 && c[4] >= 1;
        }
