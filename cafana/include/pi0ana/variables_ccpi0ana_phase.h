 ...
 */
#ifndef VARS_CCPI0ANA_PHASE_H
#define VARS_CCPI0ANA_PHASE_H
...
namespace vars::ccpi0ana_phase
{
  ...
  /*
    double category(const caf::SRInteractionTruthDLPProxy & obj)
    {
      ...
      // Signal   
      if(cuts::ccpi0ana_phase::signal_1mu0pi1pi0(obj))
      {
	if(cuts::fiducial_cut(obj))
	{
      ...
      // Neutrino Background              
      else if(cuts::ccpi0ana_phase::other_nu_1mu0pi1pi0(obj))
      {
	cat = 2;
      }
      return cat;
  ...
  */
    ...
    template<class T>
	    ...
	    {
	        if(utilities_ccpi0ana_phase::final_state_signal(p))
		{
