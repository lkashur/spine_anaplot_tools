...
*/
#ifndef CUTS_NCPI0ANA_PHASE_H
#define CUTS_NCPI0ANA_PHASE_H
#include <vector>
#include <numeric>
#include <cmath>
#include <algorithm>

#include "utilities_ncpi0ana_phase.h"

/**
 * @namespace cuts::ncpi0ana_phase
...
namespace cuts::ncpi0ana_phase
{
  ...
  //}
    ...
    template<class T>
        ...
        {
	    std::vector<uint32_t> c(utilities_ncpi0ana_phase::count_primaries(obj));
